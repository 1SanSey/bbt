...
import 'package:bbt/utils/expandable_page_view/src/size_reporting_widget.dart';
...
class _ExpandablePageViewState extends State<ExpandablePageView> {
  ...
  void _reinitializeSizes() {
    ...
    if (_currentPage >= _sizes.length) {
      final diffFromPreviousToCurrent = _previousPage - _currentPage;
      _currentPage = _sizes.length - 1;
      widget.onPageChanged?.call(_currentPage);

      _previousPage = (_currentPage + diffFromPreviousToCurrent).clamp(0, _sizes.length - 1);
    }
